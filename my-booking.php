...
?>
  ...
  <head>
    ...
    <title>Luxury Car Rental- My Booking</title>
    <!--Bootstrap -->
                          ...
                          foreach ($results as $result) {  ?>
                            ...
                            <li>
                              ...
                              <?php if ($result->Status == 1) { ?>
                                <div class="vehicle_status"> <a href="car-listing.php" class="btn outline btn-xs active-btn">Confirmed</a>
                                  <div class="clearfix"></div>
                                </div>

                              <?php } else if ($result->Status == 2) { ?>
                                <div class="vehicle_status"> <a href="car-listing.php" class="btn outline btn-xs">Cancelled</a>
                                  <div class="clearfix"></div>
                                </div>
                              ...
                              <?php } else { ?>
                                <div class="vehicle_status"> <a href="car-listing.php" class="btn outline btn-xs">Not Confirm yet</a>
                                  <div class="clearfix"></div>
                                </div>
                              <?php } ?>
